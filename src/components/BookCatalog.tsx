...
export default function BookCatalog({
  ...
  const handleExportExcel = () => {
    try {
      ...
      XLSX.writeFile(workbook, 'Katalog_Buku_SMAN1LAMPASIO.xlsx');
    } catch (error) {
  ...
  const handleDownloadTemplate = () => {
    try {
      ...
      XLSX.writeFile(workbook, 'Templat_Impor_Buku_SMAN1LAMPASIO.xlsx');
    } catch (error) {
      console.error(error);
      ...
      <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4" id="catalog-header">
        <div>
          <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">
            ...
            Katalog Buku Pustaka SMAN 1 LAMPASIO
          </h2>
